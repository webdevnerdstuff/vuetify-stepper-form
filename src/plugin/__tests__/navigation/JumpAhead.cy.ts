...
describe('Stepper Form Navigation Jump Ahead', () => {
	it('should be editable, allow all going back, allow jumping ahead', () => {
		const pages = cy.cloneArray(pagesDefault);

		cy.navigationMountComponent({ jumpAhead: true, pages });
	...
	describe('Singular Non Editable Pages', () => {
		it('should be editable, jumping ahead until before page 1', () => {
			const pages = cy.cloneArray(pagesDefault);
		...
		it('should be editable, jumping ahead until before page 2', () => {
			const pages = cy.cloneArray(pagesDefault);
		...
		it('should be editable, jumping ahead until before page 3', () => {
			const pages = cy.cloneArray(pagesDefault);
		...
		it('should be editable, jumping ahead until before page 4', () => {
			const pages = cy.cloneArray(pagesDefault);
		...
		it('should be editable, jumping ahead until before page 5', () => {
			const pages = cy.cloneArray(pagesDefault);
	...
	describe('Consecutive Non Editable Pages', () => {
		...
		describe('2 Consecutive Non Editable Pages', () => {
			it('should be editable, jumping ahead only after page 2', () => {
				const pages = cy.cloneArray(pagesDefault);
				pages[0].editable = false;
				pages[1].editable = false;
			...
			it('should be editable before page 2 and after page 3', () => {
				const pages = cy.cloneArray(pagesDefault);
				pages[1].editable = false;
				pages[2].editable = false;
			...
			it('should be editable before page 3 and after page 4', () => {
				const pages = cy.cloneArray(pagesDefault);
				pages[2].editable = false;
				pages[3].editable = false;
		...
		describe('3 Consecutive Non Editable Pages', () => {
			it('should be editable, jumping ahead only after page 3', () => {
				const pages = cy.cloneArray(pagesDefault);
				pages[0].editable = false;
				pages[1].editable = false;
				pages[2].editable = false;
		...
		describe('4 Consecutive Non Editable Pages', () => {
			it('should be editable, jumping ahead only after page 4', () => {
				const pages = cy.cloneArray(pagesDefault);
				pages[0].editable = false;
				pages[1].editable = false;
				pages[2].editable = false;
